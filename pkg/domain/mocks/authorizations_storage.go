...
func (_m *AuthorizationsStorage) Load(workspaceID int, externalServiceID integration.ID, a *domain.Authorization) error {
	ret := _m.Called(workspaceID, externalServiceID, a)

	var r0 error
	if rf, ok := ret.Get(0).(func(int, integration.ID, *domain.Authorization) error); ok {

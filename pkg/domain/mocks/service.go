...
func (_m *Service) CreateAuthorization(workspaceID int, sid integration.ID, workspaceToken string, params domain.AuthParams) error {
...
func (_m *Service) GetIntegrations(workspaceID int) ([]domain.Integration, error) {
...
func (_m *Service) GetPipe(workspaceID int, sid integration.ID, pid integration.PipeID) (*domain.Pipe, error) {
	ret := _m.Called(workspaceID, sid, pid)
...
func (_m *Service) Run(_a0 *domain.Pipe) {
	_m.Called(_a0)
}

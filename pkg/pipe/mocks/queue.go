...
func (_m *Queue) GetPipesFromQueue() ([]*pipe.Pipe, error) {
	ret := _m.Called()
...
func (_m *Queue) QueuePipeAsFirst(_a0 *pipe.Pipe) error {
	ret := _m.Called(_a0)
...
func (_m *Queue) SetQueuedPipeSynced(_a0 *pipe.Pipe) error {
	ret := _m.Called(_a0)

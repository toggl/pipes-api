...
func (_m *TogglClient) PostClients(clientsPipeID integration.PipeID, clients interface{}) (*toggl.ClientsImport, error) {
...
func (_m *TogglClient) PostProjects(projectsPipeID integration.PipeID, projects interface{}) (*toggl.ProjectsImport, error) {
...
func (_m *TogglClient) PostTasks(tasksPipeID integration.PipeID, tasks interface{}) (*toggl.TasksImport, error) {
...
func (_m *TogglClient) PostTodoLists(tasksPipeID integration.PipeID, tasks interface{}) (*toggl.TasksImport, error) {
	ret := _m.Called(tasksPipeID, tasks)
...
func (_m *TogglClient) PostUsers(usersPipeID integration.PipeID, users interface{}) (*toggl.UsersImport, error) {

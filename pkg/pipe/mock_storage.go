...
func (_m *MockStorage) LoadAuthorizationType(serviceID integrations.ExternalServiceID) (string, error) {
...
func (_m *MockStorage) LoadIntegrations() ([]*Integration, error) {
	ret := _m.Called()
...
func (_m *MockStorage) SaveAuthorizationType(serviceID integrations.ExternalServiceID, authType string) error {
